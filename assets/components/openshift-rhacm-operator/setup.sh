...
KUSTOMIZE_BASE="$PROJECT_DIR/assets/kustomize/base/openshift-rhacm-operator"
...
show_msg "show-date" "INFO" "Installing Operator RHACM Operator" "⏳"
...
# Show end message
show_msg "show-date" "INFO" "Installing Operator RHACM Operator" "Completed" "✅"
