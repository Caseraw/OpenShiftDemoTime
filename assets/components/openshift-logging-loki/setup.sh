...
KUSTOMIZE_BASE="$PROJECT_DIR/assets/kustomize/base/openshift-logging-loki"
...
show_msg "show-date" "INFO" "Setup LokiStack" "⏳"
...
# Show end message
show_msg "show-date" "INFO" "Setup LokiStack" "Completed" "✅"
